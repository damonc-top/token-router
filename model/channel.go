...
type Channel struct {
	...
	ManualBalanceEnabled       bool    `json:"manual_balance_enabled" gorm:"default:false"`
	ManualBalanceAmount        float64 `json:"manual_balance_amount" gorm:"default:0"` // in USD
	ManualBalanceResetPeriod   string  `json:"manual_balance_reset_period" gorm:"type:varchar(16);default:'monthly'"`
	ManualBalanceNextResetTime int64   `json:"manual_balance_next_reset_time" gorm:"bigint;default:0;index"`
...
func updateChannelUsedQuota(id int, quota int) {
	...
	updateChannelManualBalanceUsage(id, quota)
}
