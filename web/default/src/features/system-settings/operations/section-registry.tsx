    ...
    build: (settings: OperationsSettings) => (
      <PerformanceSection
        defaultValues={{
          ...
          'message_log_setting.enabled':
            settings['message_log_setting.enabled'] ?? false,
          'message_log_setting.retention_days':
            settings['message_log_setting.retention_days'] ?? 7,
          'message_log_setting.max_size_mb':
            settings['message_log_setting.max_size_mb'] ?? 1024,
        }}
      />
    ),
  },
